    ...
    <div className="space-y-4">
      ...
      {sourceConfidence !== "high" && (
        ...
        >
          ...
          <span className="ml-1">
            — {sourceRemark || "Enter the lines manually and verify against the original before issue."}
          </span>
        </div>
      )}
      ...
      <div className="rounded-xl border border-border bg-card">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-border">
          ...
          <button
            ...
            disabled={!canLock}
            className="flex items-center gap-2 rounded-md px-5 py-2 text-sm font-semibold text-white disabled:opacity-40"
