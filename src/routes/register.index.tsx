...
// Generic (un-tokenized) onboarding at /register — submissions go to the n8n registration
// pipeline. Tokenized capture (pre-filled, pending-approval) lives at /register/$token.
